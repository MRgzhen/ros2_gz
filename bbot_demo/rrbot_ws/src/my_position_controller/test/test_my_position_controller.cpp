...
#include "test_my_position_controller.hpp"

using my_position_controller::CMD_MY_ITFS;
using my_position_controller::control_mode_type;
using my_position_controller::STATE_MY_ITFS;

class MyPositionControllerTest : public MyPositionControllerFixture<TestableMyPositionController>
{
};

TEST_F(MyPositionControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(MyPositionControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(MyPositionControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(MyPositionControllerTest, update_success)
{
  SetUpController();
...
TEST_F(MyPositionControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(MyPositionControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(MyPositionControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(MyPositionControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(MyPositionControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(MyPositionControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(MyPositionControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
