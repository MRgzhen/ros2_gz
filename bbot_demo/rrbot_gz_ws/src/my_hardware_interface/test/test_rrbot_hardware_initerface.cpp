...
protected:
  void SetUp() override
  {
    ...
    rrbot_hardware_initerface_2dof_ =
      R"(
  ...
  std::string rrbot_hardware_initerface_2dof_;
};

TEST_F(TestRRBotHardwareInterface, load_rrbot_hardware_initerface_2dof)
{
  auto urdf = ros2_control_test_assets::urdf_head + rrbot_hardware_initerface_2dof_ +
